...
namespace kgl
{
    ...
    void Mesh::Setup(VertexType vertex_type, const unsigned char* vertex_data, uint32_t vertex_byte_count, const uint32_t* index_data, uint32_t index_byte_count, const std::vector<TextureSPtr>& texture_array, const glm::mat4& local_transform_matrix)
    {
        this->Clear();
    ...
    void Mesh::SetupVertexAttributeBuffer(VertexType vt)
    {
        ...
        case VERTEX_TYPE_PNBONET1:this->SetupVertexAttributeBufferPNBoneT1(); break;
        }
    }

    void Mesh::SetupVertexAttributeBufferPNBoneT1()
    {
