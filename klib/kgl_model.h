...
namespace kgl
{
    ...
    public:
        /// <summary>
        /// 类<see cref="Model"/>的构造函数
        /// </summary>
        /// <param name="vt">构成本模型的顶点类型</param>
        /// <param name="path">本模型文件的路径</param>
        ...
        virtual void ApplyShaderToMesh(std::size_t index, GPUProgramSPtr shader);

        /// <summary>
        /// 把某个shader程序，作用到模型中每一个mesh上
        /// </summary>
        /// <param name="shader">待使用的shader</param>
        virtual void ApplyShaderToModel(GPUProgramSPtr shader);

        /// <summary>
        /// 获取指定的mesh所使用的shader
        /// </summary>
        /// <param name="index">模型中的某个mesh的索引值</param>
        /// <returns>指定的mesh所使用的shader</returns>
        ...
        virtual void DrawSubset(std::size_t mesh_index);
    protected:
        /// <summary>
        /// Loads the model.
        /// </summary>
        ...
        virtual void ProcessNode(const aiScene* scene, const aiNode* node, const glm::mat4& parent_trransform);
        ...
        virtual Mesh* ProcessMesh(uint32_t mesh_index, const aiScene* scene, aiMesh* mesh, const glm::mat4& model_transform) = 0;
        ...
        uint8_t* ReadVertexData(VertexType vt, uint32_t mesh_index, const aiMesh* mesh, uint32_t* vertex_byte_count);
        ...
        /// <param name="vertex_byte_count">The vertex_byte_count.</param>
        /// <returns>uint8_t *.</returns>
        virtual uint8_t* ReadVertexDataP(uint32_t mesh_index, const aiMesh* mesh, uint32_t* vertex_byte_count);
        ...
        /// <param name="vertex_byte_count">The vertex_byte_count.</param>
        /// <returns>uint8_t *.</returns>
        virtual uint8_t* ReadVertexDataPC(uint32_t mesh_index, const aiMesh* mesh, uint32_t* vertex_byte_count);
        ...
        /// <param name="vertex_byte_count">The vertex_byte_count.</param>
        /// <returns>uint8_t *.</returns>
        virtual uint8_t* ReadVertexDataPN(uint32_t mesh_index, const aiMesh* mesh, uint32_t* vertex_byte_count);
        ...
        /// <param name="vertex_byte_count">The vertex_byte_count.</param>
        /// <returns>uint8_t *.</returns>
        virtual uint8_t* ReadVertexDataPNTB(uint32_t mesh_index, const aiMesh* mesh, uint32_t* vertex_byte_count);
        ...
        /// <param name="vertex_byte_count">The vertex_byte_count.</param>
        /// <returns>uint8_t *.</returns>
        virtual uint8_t* ReadVertexDataPNTBT1(uint32_t mesh_index, const aiMesh* mesh, uint32_t* vertex_byte_count);
        ...
        /// <param name="vertex_byte_count">The vertex_byte_count.</param>
        /// <returns>uint8_t *.</returns>
        virtual uint8_t* ReadVertexDataPNTBT2(uint32_t mesh_index, const aiMesh* mesh, uint32_t* vertex_byte_count);
        ...
        /// <param name="vertex_byte_count">The vertex_byte_count.</param>
        /// <returns>uint8_t *.</returns>
        virtual uint8_t* ReadVertexDataPNTBT3(uint32_t mesh_index, const aiMesh* mesh, uint32_t* vertex_byte_count);
        ...
        /// <param name="vertex_byte_count">The vertex_byte_count.</param>
        /// <returns>uint8_t *.</returns>
        virtual uint8_t* ReadVertexDataPNTBT4(uint32_t mesh_index, const aiMesh* mesh, uint32_t* vertex_byte_count);
        ...
        /// <param name="vertex_byte_count">The vertex_byte_count.</param>
        /// <returns>uint8_t *.</returns>
        virtual uint8_t* ReadVertexDataPNT1(uint32_t mesh_index, const aiMesh* mesh, uint32_t* vertex_byte_count);
        ...
        /// <param name="vertex_byte_count">The vertex_byte_count.</param>
        /// <returns>uint8_t *.</returns>
        virtual uint8_t* ReadVertexDataPNT2(uint32_t mesh_index, const aiMesh* mesh, uint32_t* vertex_byte_count);
        ...
        /// <param name="vertex_byte_count">The vertex_byte_count.</param>
        /// <returns>uint8_t *.</returns>
        virtual uint8_t* ReadVertexDataPNT3(uint32_t mesh_index, const aiMesh* mesh, uint32_t* vertex_byte_count);
        ...
        /// <param name="vertex_byte_count">The vertex_byte_count.</param>
        /// <returns>uint8_t *.</returns>
        virtual uint8_t* ReadVertexDataPNT4(uint32_t mesh_index, const aiMesh* mesh, uint32_t* vertex_byte_count);

        virtual uint8_t* ReadVertexDataPNBoneT1(uint32_t mesh_index, const aiMesh* mesh, uint32_t* vertex_byte_count);
