...
namespace kgl
{
	...
	private:
		...
		RenderStateCullMode cull_mode_before_draw_;  // 绘制前的拣选模式
		RenderStateCullMode cull_mode_draw_;		 // 绘制时的cull mode
		RenderStateDepth	depth_state_before_draw_;
		RenderStateDepth    depth_state_draw_;
		Model*				model_;
	};
}
